...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_minic = 31,                     /* minic  */
  YYSYMBOL_extern = 32,                    /* extern  */
  YYSYMBOL_func_def = 33,                  /* func_def  */
  YYSYMBOL_term = 34,                      /* term  */
  YYSYMBOL_block_statement = 35,           /* block_statement  */
  YYSYMBOL_var_decs = 36,                  /* var_decs  */
  ...
  YYSYMBOL_call_statement = 41,            /* call_statement  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "EXTERN", "INT",
  "VOID", "RETURN", "IF", "ELSE", "WHILE", "LT", "GT", "LE", "GE", "EQ",
  "NEQ", "NUM", "NAME", "READ", "PRINT", "'('", "')'", "';'", "'{'", "'}'",
  "'='", "'+'", "'-'", "'/'", "'*'", "$accept", "minic", "extern",
  "func_def", "term", "block_statement", "var_decs", "declaration",
  "statements", "statement", "assign_statement", "call_statement",
  "return_statement", "expression", "condition", "if_statement",
...
{
       5,     6,    17,     5,     1,    12,   -42,    29,    18,    26,
      31,   -42,    33,    45,    36,    35,    37,    -3,   -42,    38,
      42,    43,   -42,    47,    28,   -42,    43,    50,     9,    51,
      51,    48,    56,   -42,    28,   -42,    46,   -42,   -42,   -42,
     -42,   -42,   -42,   -42,    53,   -42,   -42,    11,    72,    62,
      11,    74,    74,   -13,     9,   -42,    55,   -42,   -42,   -42,
     -42,   -42,    11,    11,    11,    11,   -42,   100,    69,   -42,
      65,    80,    64,    61,    71,   -42,   -42,   -42,   -42,   -42,
      11,    11,    11,    11,    11,    11,    74,    75,   -42,   -42,
      73,    81,    83,    84,    95,    96,    97,    98,   -42,    99,
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     2,     0,     0,     0,     0,     0,     0,     4,     0,
       0,     0,     3,     0,     0,     6,     0,     0,     0,     0,
       0,     0,     0,    19,     0,    12,     0,    15,    16,    20,
      21,    17,    18,     5,     0,     8,     7,     0,     0,     0,
       0,     0,     0,     0,     0,    11,     0,     9,    14,    13,
      33,    27,     0,     0,     0,     0,    28,     0,    40,    42,
       0,     0,     0,     0,     0,    10,    29,    30,    31,    32,
       0,     0,     0,     0,     0,     0,     0,     0,    23,    22,
       0,     0,     0,     0,     0,     0,     0,     0,    41,     0,
      26,    25,    34,    35,    36,    37,    38,    39,    24
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -42,   -42,   117,   -42,   -41,   -19,   -42,    88,    89,   -36,
     -42,   -42,   -42,   -24,    94,   -42,   -42
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     2,     3,    11,    48,    33,    34,    35,    36,    37,
      38,    39,    40,    49,    51,    41,    42
};
...
{
      58,    20,    25,    45,    46,    70,    60,    43,     1,    67,
       4,     5,    71,    73,    47,    68,    69,     6,    21,     8,
      58,    76,    77,    78,    79,    45,    46,    45,    46,    72,
      74,     9,    27,    10,    28,    29,    47,    30,    12,    92,
      93,    94,    95,    96,    97,    31,    13,    32,    14,    16,
      98,    24,    28,    29,    15,    30,    17,    18,    19,    23,
      22,    28,    29,    31,    30,    32,    24,    44,    26,    24,
      57,    50,    31,    53,    32,    59,    54,    86,    24,    75,
      28,    29,    90,    30,    66,    87,    89,    62,    63,    64,
      65,    31,    91,    32,    61,   100,    99,    24,    62,    63,
      64,    65,    88,   101,   102,   103,    62,    63,    64,    65,
      80,    81,    82,    83,    84,    85,   104,   105,   106,   107,
       7,   108,    55,    56,    52
};

static const yytype_int8 yycheck[] =
{
      36,     4,    21,    16,    17,    18,    47,    26,     3,    50,
       4,     5,    53,    54,    27,    51,    52,     0,    21,    18,
      56,    62,    63,    64,    65,    16,    17,    16,    17,    53,
      54,    19,     4,     4,     6,     7,    27,     9,    20,    80,
      81,    82,    83,    84,    85,    17,    20,    19,    17,     4,
      86,    23,     6,     7,    21,     9,    20,    22,    21,    17,
      22,     6,     7,    17,     9,    19,    23,    17,    21,    23,
      24,    20,    17,    25,    19,    22,    20,     8,    23,    24,
       6,     7,    21,     9,    22,    20,    22,    26,    27,    28,
      29,    17,    21,    19,    22,    22,    21,    23,    26,    27,
      28,    29,    22,    22,    21,    21,    26,    27,    28,    29,
      10,    11,    12,    13,    14,    15,    21,    21,    21,    21,
       3,    22,    34,    34,    30
};
...
{
       0,     3,    31,    32,     4,     5,     0,    32,    18,    19,
       4,    33,    20,    20,    17,    21,     4,    20,    22,    21,
       4,    21,    22,    17,    23,    35,    21,     4,     6,     7,
       9,    17,    19,    35,    36,    37,    38,    39,    40,    41,
      42,    45,    46,    35,    17,    16,    17,    27,    34,    43,
      20,    44,    44,    25,    20,    37,    38,    24,    39,    22,
      34,    22,    26,    27,    28,    29,    22,    34,    39,    39,
      18,    34,    43,    34,    43,    24,    34,    34,    34,    34,
      10,    11,    12,    13,    14,    15,     8,    20,    22,    22,
      21,    21,    34,    34,    34,    34,    34,    34,    39,    21,
      22,    22,    21,    21,    21,    21,    21,    21,    22
};
...
#line 33 "grammar.y"
                               { (yyval.node) = createProg((yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); printNode((yyval.node)); free((yyval.node)) }
#line 1267 "y.tab.c"
    break;

  case 3: /* extern: EXTERN VOID PRINT '(' INT ')' ';'  */
#line 37 "grammar.y"
                                          { (yyval.node) = createExtern((yyvsp[-4].string));}
#line 1273 "y.tab.c"
    break;

  case 4: /* extern: EXTERN INT READ '(' ')' ';'  */
#line 38 "grammar.y"
                                    { (yyval.node) = createExtern((yyvsp[-3].string)); }
#line 1279 "y.tab.c"
    break;

  case 5: /* func_def: INT NAME '(' INT NAME ')' block_statement  */
#line 42 "grammar.y"
                                                  { (yyval.node) = createFunc((yyvsp[-5].string), createVar((yyvsp[-2].string)), (yyvsp[0].node)); }
#line 1285 "y.tab.c"
    break;

  case 6: /* func_def: INT NAME '(' ')' block_statement  */
#line 43 "grammar.y"
                                         { (yyval.node) = createFunc((yyvsp[-3].string), NULL, (yyvsp[0].node)); }
#line 1291 "y.tab.c"
    break;
...
#line 84 "grammar.y"
                                { (yyval.node) = createAsgn(createVar((yyvsp[-3].string)), (yyvsp[-1].node)); }
#line 1391 "y.tab.c"
    break;
...
#line 86 "grammar.y"
                                  { (yyval.node) = createAsgn(createVar((yyvsp[-5].string)), createCall((yyvsp[-3].string))); }
#line 1403 "y.tab.c"
    break;

  case 25: /* call_statement: PRINT '(' expression ')' ';'  */
#line 90 "grammar.y"
                                     { (yyval.node) = createCall((yyvsp[-4].string), (yyvsp[-2].node)) ;}
#line 1409 "y.tab.c"
    break;
